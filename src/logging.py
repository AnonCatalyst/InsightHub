from PyQt5.QtWidgets import QWidget, QVBoxLayout, QTabWidget, QTextEdit, QPushButton, QHBoxLayout, QFileDialog, QMessageBox, QCheckBox
from PyQt5.QtGui import QIcon, QTextCursor
from PyQt5.QtCore import Qt, QDateTime, QFile, QTextStream
    ...
    def save_logs(self):
        ...
        if file_dialog.exec() == QFileDialog.Accepted:
            ...
            if QFile.exists(file_path):
                ret = QMessageBox.warning(self, "File Exists", f"The file {file_path} already exists. Do you want to overwrite it?", QMessageBox.Yes | QMessageBox.No)
